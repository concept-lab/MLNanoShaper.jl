...
# ╔═╡ 1fdf8d4a-411e-11f0-3bc4-1daceaa2e238
using TensorBoardLogger, ValueHistories, DataFrames, CSV

# ╔═╡ a47a197d-3efe-4d7f-8c7e-bfb62e4b949c
function get_logger(log_path)
	logger = TBReader("$(homedir())/datasets/logs/$log_path")
	convert(MVHistory, logger)
end

# ╔═╡ d14f32c7-831f-470e-b41a-1cc346571ef8
...
function get_comparaison_dataframe(
	...
	columns = [get_test_value.(Ref(hist),region .* "/" .* field) .|> f for field in fields]
	hcat(DataFrame(;region),DataFrame(columns,names))
end
...
manifest_format = "2.0"
project_hash = "14637b4e936cf048e0c58d542530e66b373d0ae9"
...
git-tree-sha1 = "fc4db306152dbc89035d5c6d9319a69cf5d4f4b9"
...
git-tree-sha1 = "898fd634b251ee7b0e24d629fd4ea517ee1cf068"
