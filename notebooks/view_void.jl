...
using Revise,MLNanoShaper, MLNanoShaperRunner, Serialization, Static, StructArrays, FileIO, GeometryBasics, Folds, Lux, CUDA
...
atoms = AnnotedKDTree(read("fullerene.xyzr",MLNanoShaperRunner.Import.XYZR{Float32}) |> StructVector,static(:center))
...
slice1 = get_slice(atoms,models[1],0.0,(;cutoff_radius=3.0f0,step,default_value=-10f0))

# ╔═╡ db5ea403-dabc-4825-a293-4f43945ca0f2
slice2 = get_slice(atoms,models[2],0.0,(;cutoff_radius=2.0f0,step,default_value=0.0f0))
